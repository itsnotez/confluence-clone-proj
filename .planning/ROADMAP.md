...
- [ ] **Phase 1: 사용자·Space·콘텐츠·권한 기본 기능** - CRUD API + 프론트엔드 핵심 화면
- [ ] **Phase 2: 메일 서버 연동** - IMAP Polling 기반 메일 동기화
...
- [ ] 01-04: 콘텐츠 CRUD + 트리 API (백엔드)
- [ ] 01-05: Space 프론트엔드 — SpaceListView, SpaceHomeView, ContentTree
- [ ] 01-06: 콘텐츠 편집기 — ContentView, ContentEditorView (TipTap)
- [ ] 01-07: 버전 관리 + VersionHistoryPanel + SpacePermissionView
